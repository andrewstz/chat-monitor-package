...
echo Building Windows application (UV Fixed Version - No pyproject.toml dependency)...
...
:: Install core dependencies using UV (faster)
echo Installing core dependencies using UV...
uv pip install opencv-python ultralytics Pillow requests PyYAML psutil

:: Install PyInstaller using UV
echo Installing PyInstaller using UV...
uv pip install pyinstaller

:: Create PyInstaller command directly (avoid uv run)
