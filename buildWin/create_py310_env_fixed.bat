...
echo ========================================
echo Creating Python 3.10 UV Environment (Fixed)
echo ========================================
...
:: Try to create environment with Python 3.10 specification
echo.
echo Creating UV environment with Python 3.10 specification...
echo Note: This will use system Python but specify 3.10 compatibility

:: Method 1: Try with --python 3.10
uv venv --python 3.10 .venv_py310 2>nul
if errorlevel 1 (
    echo Method 1 failed, trying alternative approach...
    
    :: Method 2: Create environment without version constraint
    uv venv .venv_py310
)
...
echo ========================================
echo Python environment: .venv_py310
echo.
