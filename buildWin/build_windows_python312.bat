@echo off
echo Building Windows 10 compatible version for Python 3.12+...
...
REM Install compatible dependencies for Python 3.12+
echo Installing Python 3.12+ compatible dependencies...

echo Installing numpy (Python 3.12+ compatible)...
uv pip install numpy>=1.26.0 -i https://mirrors.aliyun.com/pypi/simple/
if errorlevel 1 (
    echo Trying numpy 1.26.4...
    uv pip install numpy==1.26.4 -i https://mirrors.aliyun.com/pypi/simple/
)

echo Installing opencv-python...
uv pip install opencv-python>=4.9.0 -i https://mirrors.aliyun.com/pypi/simple/
if errorlevel 1 (
    echo Trying opencv-python-headless...
    uv pip install opencv-python-headless>=4.9.0 -i https://mirrors.aliyun.com/pypi/simple/
)

echo Installing ultralytics...
uv pip install ultralytics>=8.1.0 -i https://mirrors.aliyun.com/pypi/simple/
if errorlevel 1 (
    echo Trying ultralytics 8.1.0...
    uv pip install ultralytics==8.1.0 -i https://mirrors.aliyun.com/pypi/simple/
)

echo Installing Pillow...
uv pip install Pillow>=10.1.0 -i https://mirrors.aliyun.com/pypi/simple/
if errorlevel 1 (
...
if errorlevel 1 (
    echo Trying lap 0.4.0...
    uv pip install lap==0.4.0 -i https://mirrors.aliyun.com/pypi/simple/
)

REM Install PyInstaller
echo Installing PyInstaller...
uv pip install pyinstaller>=6.0.0 -i https://mirrors.aliyun.com/pypi/simple/
if errorlevel 1 (
    echo Trying PyInstaller 6.0.0...
    uv pip install pyinstaller==6.0.0 -i https://mirrors.aliyun.com/pypi/simple/
    if errorlevel 1 (
        echo Trying PyInstaller 5.13.2...
