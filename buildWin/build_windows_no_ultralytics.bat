...
echo Building Windows application (No Ultralytics Version)...
...
:: Install core dependencies (without ultralytics)
echo Installing core dependencies (without ultralytics)...
uv pip install opencv-python Pillow requests PyYAML psutil pyautogui pytesseract watchdog
...
if exist "dist\ChatMonitor.exe" (
    ...
    echo.
    echo NOTE: This version does not include YOLO model support
    echo You can now:
